...
def headerBody():
    ...
    for n in range(1,len(data1)):
        ...
        except ValueError: pass #print round(xSd,3),'   ',round(ySd,3)
        ...
        for d in range(0,len(dist)):
            if (dist[w][6] != '1E+12' and dist[d][5] != '1E+12' and\
               ...
               (int(dist[w][6]) == int(dist[d][5])\
                ...
                dist[w][2] != dist[d][2]:
                pass
##                yield dist[w][2],int(dist[w][5]),int(dist[w][6]),dist[w][11],\
##                      dist[w][12],dist[w][13],dist[w][14],dist[w][15],'W'
##                yield dist[d][2],int(dist[d][5]),int(dist[d][6]),dist[d][11],\
